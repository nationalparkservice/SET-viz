...
### PICK UP FROM HERE--DOES NOT CALC THRESH FOR BISCAYNE BISC1. FOR A LOT OF SITES, GET PLOT ERRORS.
### FIX
# Add title to leaflet map
# LM trend line--change it to LMER? (does it matter)
# Legend element duplicated on highlight (time series)
