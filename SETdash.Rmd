...
renderUI({
  ...
  keep_choices <- c(length(unique(na.omit(rv$SubDataSET$pin_height_mm))) > 1,
      ...
      radioButtons("sel_SETmetric",
                   ...
                   choiceNames = list("Pin height (mm)", "Standardized pin height (mm)", "Orthometric height (m)")[keep_choices],
...
* Best-fit lines color-coded by SET direction (SET arm) are included for visual purposes only (this is NOT a trend analysis).
